...
function gamePV_load() {
    ...
    ajaxLoad("http://"+ window.location.host +"/Service/GamePv/index", "gameId=" + game_id, ajaxOnLogoResult);
}
...
function score_submit(gameScore, gameType) {
    ...
    ajaxLoad("http://"+ window.location.host +"/Service/Score/index", "gameScore=" + gameScore + "&gameId=" + game_id + "&gameType=" + gameType, scoreResult);
}
